...
namespace Drupal\Tests\guardr\Functional;
...
/**
 * Tests Guardr installation profile expectations.
 *
 * @group guardr
 */
class GuardrTest extends BrowserTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'guardr';
  ...
  public function testGuardr() {
    ...
    // guardr profile modules are enabled.
